...
import { ShieldAlert, Lock, Mail, AlertCircle, ArrowRight, Eye, EyeOff } from 'lucide-react';
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-11 py-2.5 rounded-xl bg-slate-800 border border-slate-700 text-sm text-white focus:ring-2 focus:ring-purple-500 outline-hidden"
                placeholder="••••••••"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-2.5 text-slate-400 hover:text-slate-200 focus:outline-hidden p-0.5"
              >
