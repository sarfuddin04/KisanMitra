  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-3xl p-8 sm:p-10 border border-emerald-100 shadow-xl space-y-6">
        ...
        {/* Demo Login Shortcut for Farmers */}
        <div className="bg-emerald-50/70 p-3.5 rounded-2xl border border-emerald-200/80 space-y-2">
          <p className="text-[11px] font-bold text-emerald-900 text-center uppercase tracking-wider">
            Quick One-Click Farmer Demo
          </p>
          <div>
            <button
              type="button"
              onClick={() => handleQuickLogin('farmer@kisanmitra.ai', 'Farmer@123')}
              className="w-full px-2.5 py-2 bg-white hover:bg-emerald-100/70 text-emerald-800 border border-emerald-300 rounded-xl text-xs font-bold transition-all flex items-center justify-center space-x-1.5 shadow-xs"
            >
              <UserCheck className="w-3.5 h-3.5 text-emerald-600" />
              <span>Fill Farmer Demo Credentials</span>
            </button>
          </div>
        </div>
